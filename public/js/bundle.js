      ...
      function (require, module, exports) {
        ...
        var displayMap = function displayMap(locations) {
          mapboxgl.accessToken =
            'pk.eyJ1IjoiaG11aGFzaGFteSIsImEiOiJjbGFuc2lxMTIwc2hlM3hsYmxsMXd0amZwIn0.69ZBWZxQESdrJiWcT2edvg';
          var map = new mapboxgl.Map({
            container: 'map',
            style: 'mapbox://styles/hmuhashamy/clant0kuo008w15qmwkcjhdjx',
            scrollZoom: false,
            // center: [-118.24693758025926, 34.05405029790215],
            // zoom: 10,
            // interactive: false,
          });
